...
Bundled PuzzleSans (Roboto) removes the network dependency for typography. Body text is generally 14–16; game names 18; section labels 22; the home headline 34. Use medium/bold weights intentionally and keep the board visually dominant.
